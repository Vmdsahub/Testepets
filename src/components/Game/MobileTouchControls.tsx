...
export const MobileTouchControls: React.FC<TouchControlsProps> = ({
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-30">
      ...
      {/* Shoot Button - Bottom Right - Hidden when disabled */}
      {!isShootingDisabled && (
        <div className="absolute bottom-8 right-8 pointer-events-auto">
          <motion.button
            className="w-20 h-20 rounded-full flex items-center justify-center shadow-lg border-3 transition-all duration-200 bg-red-500/80 border-red-400/50 hover:bg-red-500/90 active:bg-red-600/90"
